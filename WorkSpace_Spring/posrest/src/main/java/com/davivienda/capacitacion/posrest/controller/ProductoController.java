...
public class ProductoController {
	...
	@GetMapping("/findByFecha/{fecha}/{numPage}/{tamPagina}")
	public List<ProductoDto> findByFecha(@PathVariable("fecha") LocalDate fecha, @PathVariable("numPage") Integer numPage, @PathVariable("tamPagina") Integer tamPagina) {
		List<ProductoDto> lstResultado = prodSvc.findByFecha(fecha, numPage, tamPagina);
		return lstResultado;
	}
	
	@GetMapping("/findAllPaginable/{numPage}/{tamPagina}/{sortBy}/{ascdsc}")
	public List<ProductoDto> findAllPaginable(@PathVariable("numPage") Integer numPage, @PathVariable("tamPagina") Integer tamPagina, 
												@PathVariable("sortBy") String sortBy, @PathVariable("ascdsc") String ascdsc) {
		List<ProductoDto> lstResultado = prodSvc.findAllPaginable(numPage, tamPagina, sortBy, ascdsc);
		return lstResultado;
	}
	
	@GetMapping("/consultarTodos")
	public List<ProductoDto> consultarTodos() {
		List<ProductoDto> lstProductos = this.prodSvc.consultarTodos(); 
		return lstProductos;
	}
}
